...
exports.main = function(options, callbacks) {
	...
	if (require('self').loadReason !== 'downgrade') {
		//Request services and store locally
		Request({
			url: "http://tos-dr.info/index/services.json",
	...
	var panel = require("panel").Panel({
		...
		contentScriptFile: [data.url("libs/jquery-1.8.0.min.js"),
							data.url("popup.js")],
...
exports.onUntrack = function (reason) {
	if (reason !== 'shutdown') {
		listeners.remove();
	}
};